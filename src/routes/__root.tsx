...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Academy — Plataforma LMS" },
      { name: "twitter:title", content: "Academy — Plataforma LMS" },
      { property: "og:description", content: "Plataforma de cursos Academy" },
      { name: "twitter:description", content: "Plataforma de cursos Academy" },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/IvcMHxXpPCXQnDqogqln8PzZ2YV2/social-images/social-1782396756396-capa_curso.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/IvcMHxXpPCXQnDqogqln8PzZ2YV2/social-images/social-1782396756396-capa_curso.webp" },
