...
function LessonPage() {
  ...
  const { isCompleted, setLessonCompleted, moduleProgress, courseProgress } = useProgress();
  const navigate = useNavigate();

  const done = isCompleted(lesson.id);
  const modP = moduleProgress(mod.id);
  const courseP = courseProgress();
          ...
          <div className="space-y-4 rounded-2xl border border-border bg-card p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div className="min-w-0">
                ...
                <h1 className="mt-1 text-xl font-bold md:text-2xl">{lesson.title}</h1>
        ...
        <aside className="lg:sticky lg:top-20 lg:self-start">
          <div className="overflow-hidden rounded-2xl border border-border bg-card">
            <div className="border-b border-border p-4">
              ...
              <h3 className="truncate font-bold">{mod.title}</h3>
